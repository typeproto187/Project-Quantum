...
@ -I ./arch/arm/mach-sunxi/include -D __KERNEL__ -D __UBOOT__ -D __ARM__
...
@ -mtune=cortex-a9 -mfpu=vfpv3 -mtls-dialect=gnu
...
.LASF18:
	.ascii	"/home/pengzhihui/Docker/linux-card-dev/_share/bootl"
	.ascii	"oader/u-boot\000"
.LASF9:
	.ascii	"char\000"
.LASF0:
...
.LASF20:
	.ascii	"main\000"
.LASF16:
	.ascii	"GNU C 4.9.3 -mthumb -mthumb-interwork -mabi=aapcs-l"
	.ascii	"inux -mword-relocations -mno-unaligned-access -mflo"
	.ascii	"at-abi=soft -march=armv7-a -mtune=cortex-a9 -mfpu=v"
	.ascii	"fpv3 -mtls-dialect=gnu -g -Os -fno-builtin -ffreest"
	.ascii	"anding -fshort-wchar -fno-stack-protector -fno-dele"
